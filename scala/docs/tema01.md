...
```
* El método ```eventually```recibe  a una función como parámetro representada por la aserción indicada entre { } 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MjAyMTA0NzEsMTA4OTYwMTk4LC0zOT
