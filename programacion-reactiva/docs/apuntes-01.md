...
* Responsiva (tiempos de respuesta constantes y rápidos) . 
	...
	* El sistema siempre debe proporcionar una respuesta  al cliente, el cliente no debe esperar por una respuesta: *Siempre dame algo en lugar de esperar por
* Elastic (escalable)
...
* ``Completable``
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA4MzQ5Mzg1OF19
-->