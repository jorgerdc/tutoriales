...
* Es una técnica de programación  en la que las tareas a realizar se ejecutan de manera asíncrona. Esta ejecución está regida o dirigida co
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxNDY1MTgxODhdfQ==
-->